...
def printing(button,inputs):
    ...
    while True:
        if button.value!=17 and len(inputs)!=0 and previous!=inputs[-1][0]:
            ...
            break
    pd.DataFrame(training_data).to_csv("/home/akshay/data/personal/Python_projects/Snake/training_data_4.csv",index=False)
...
def main():
    ...
    p2 = multiprocessing.Process(target=controller, args=(flag_1,))
